...
**Proof.**
1. *(Weights add.)* Since $J_3^{\text{tot}}=J_3\otimes I + I\otimes J_3$, the product basis $|j_1,m_1\rangle\otimes|j_2,m_2\rangle$ is a $J_3^{\text{tot}}$-eigenbasis with eigenvalue $m=m_1+m_2$. Count how many product states have each total $m$: it is the number of pairs $(m_1,m_2)$ with $m_1+m_2=m$, which (for $j_1\ge j_2$) equals $j_2 - |m| + (j_1 + 1)$ pattern — concretely the multiplicities of $m$ run $1,2,3,\dots$ up to $2j_2+1$ and then plateau, decreasing symmetrically at the ends.
